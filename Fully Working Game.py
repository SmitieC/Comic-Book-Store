...
while True:
    ...
    if game_over:
        ...
        screen.blit(game_font.render("Your Score was " + str(score_now), True, black), (200, 300))
        if score_now > high_score:
            high_score = score_now
        with open("HI_score.txt", "w") as f:
            f.write(str(high_score))
        screen.blit(game_font.render("The High Score now is: " + str(high_score), True, black), (200, 350))
